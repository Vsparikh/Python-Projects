...
# controls
# change translate_x and translate_y to move the simulation on the screen
translate_x = 150
translate_y = 250
...
while flag:
    ...
    for m in range(0, terms):
        ...
        g.draw.line(win, (30, 144, 255), (translate_x + pre_x, translate_y + pre_y), (translate_x + x, translate_y + y), 2)
        # point on the circle
